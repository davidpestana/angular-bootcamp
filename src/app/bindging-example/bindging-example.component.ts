...
@Component({
  selector: 'app-bindging-example',
  templateUrl: './bindging-example.component.html',
  styleUrls: ['./bindging-example.component.sass']
})
export class BindgingExampleComponent {
